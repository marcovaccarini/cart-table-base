                                ...
                                @foreach($featureds as $featured)
                                    ...
                                    <div class="paddings-container">
                                        <div class="product-slide-entry">
                                            ...
                                            <a class="title" href="#">{{$featured->product_name}}</a>
                                            <div class="price">
                                                @if($featured->custom_discount != null)
                                            ...
                                            <div class="information-blocks">
                                                <a class="button style-17" data-toggle="modal" href="ajax/product/{{$featured->id}}" data-target="#productSetailsModalAjax"><i class="fa fa-shopping-bag"></i>Add to bag</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="information-blocks">
                    ...
                    <div class="products-swiper">
                        <div class="swiper-container" data-autoplay="0" data-loop="0" data-speed="500" data-center="0" data-slides-per-view="responsive" data-xs-slides="2" data-int-slides="2" data-sm-slides="3" data-md-slides="4" data-lg-slides="5" data-add-slides="5">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="paddings-container">
                                            <div class="product-slide-entry">
                                                ...
                                                <a class="title" href="#">{{$promotion->product_name}}</a>
                                                <div class="price">
                                                    @if($promotion->custom_discount != null)
                                                ...
                                                <div class="information-blocks">
                                                    <a class="button style-17 open-product" data-toggle="modal"><i class="fa fa-shopping-bag"></i>Add to cart</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <button data-toggle="modal" data-target="#view-modal" data-id="10" id="getUser" class="btn btn-sm btn-info"><i class="glyphicon glyphicon-eye-open"></i> View</button>
